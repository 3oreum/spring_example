...
<!--  AJAX를 사용하려면 반드시 jquery 원본 필요 슬림 지워야 함 -->
...
$(document).ready(function(){
	...
	$("#nameCheckBtn").on('click', function(){
		// 중복 확인 클릭 시 nameCheckBtn 안쪽 태그들을 초기화
		// 왜냐면 안내 문구를 하나만 띄우기 위해서
		...
		$.ajax({
			// request
			type:"get" // get일 경우 생략 가능 기본이 get이라서
			, url:"/lesson06/ex02/is-duplication"
			, data:{"name":name}
			
			// response
			, success:function(data){ // data: String 또는 JSON => Dictionary
